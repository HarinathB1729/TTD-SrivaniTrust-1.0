...
function Profile() {
  ...
  return (
    <>
      ...
      <Container sx={{ padding:'45px !important',width:'30vw', border: "1px solid black", minHeight:'58vh' }}>
            ...
            {!edit && (
              <div style={{ display: "flex" }}>
                <Button
                  ...
                  size="medium"
                  variant="contained"
                  sx={{ textTransform:'none', width: "50%", margin: "20px 10px 20px 0px" }}
                >
                  Update Username
                </Button>
                <Button
                  ...
                  variant="contained"
                  color='error'
                  sx={{textTransform:'none', width: "50%", margin: "20px 0px 20px 10px" }}
                  onClick={() => {
